...
Para quem quiser ver os detalhes do lançamento, deixo o link aqui: [Ler mais](https://blog.google/products/admanager/ask-ad-manager/)

## O resto do radar

**GPT-5.6, a nova geração de modelos da OpenAI** — Redefine o benchmark de custo-benefício para features com IA e libera o modo "ultra" (agentes em paralelo) como novo padrão de produto. [Ler mais](https://openai.com/index/gpt-5-6/)

**Meta lança Muse Spark 1.1, modelo agentic multimodal** — Abre API pública para um modelo forte em uso de computador e orquestração multiagente, ampliando as opções de fornecedor além de OpenAI, Anthropic e Google. [Ler mais](https://ai.meta.com/blog/introducing-muse-spark-meta-model-api/)

**OpenAI lança GPT-Live-1, voz full-duplex para o ChatGPT** — Sinaliza a aposta da OpenAI em voz como interface primária para trabalho agentic de longa duração, relevante para quem tem voz no roadmap. [Ler mais](https://techcrunch.com/2026/07/08/openai-releases-new-voice-models-for-more-natural-live-conversations/)

**Estudo sobre adoção do Claude Code e do Copilot CLI na Microsoft** — Dados reais de adoção interna de coding agents em larga escala, úteis para calibrar expectativas de rollout e métricas de sucesso. [Ler mais](https://arxiv.org/abs/2607.01418)

**Benchmark de maturidade de agentes de IA para times de engenharia** — Framework rápido para avaliar o quanto o time está preparado para adotar agentes no fluxo de desenvolvimento. [Ler mais](https://agent-benchmarks.com/software-factory/)

**Sx 2.0: compartilhando skills de IA por uma pasta do Dropbox** — Reduz a fricção para distribuir prompts e capacidades padronizadas no time, sem precisar de infraestrutura dedicada. [Ler mais](https://sleuth-io.github.io/sx/2026/07/10/your-dropbox-is-now-a-skill-server.html)

**Clawk: VMs Linux descartáveis para agentes de coding** — Infraestrutura de isolamento que vira peça-chave de segurança e confiabilidade ao dar mais autonomia a coding agents em produção. [Ler mais](https://github.com/clawkwork/clawk)

**"O que vai sobrar para nós trabalharmos?"** — Ensaio sobre como a automação por IA redesenha papéis de trabalho, com implicações diretas para o posicionamento de produtos de IA. [Ler mais](https://www.normaltech.ai/p/what-will-be-left-for-us-to-work)
