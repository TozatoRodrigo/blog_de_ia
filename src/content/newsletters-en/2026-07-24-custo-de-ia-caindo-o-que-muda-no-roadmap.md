...
The point I try not to lose sight of is that a lower price is not an excuse to take judgment off the table. In finance, a poorly designed low-cost solution becomes expensive. The value lies in using the right model for each task: the expensive one only where it pays for itself, the cheaper one where volume leads. Designing [AI product features](/en/guides/ai-product-management/) around that routing is now almost a product decision.

That choice also belongs in the design of [AI agents](/en/guides/ai-agents/). Each stage needs a model that fits its risk, volume, and type of decision. When financial operations involve consequential actions, cost is not the only criterion: permissions and [AI governance](/en/guides/ai-governance/) are part of the architecture.
...
For anyone curious about the numbers behind this new group of models, the details are [here](https://llm-stats.com/llm-updates).

## The rest of the radar

**OpenAI Presence** — a template for operating agents in production with governance: guardrails, evaluations, and approved actions. [Read more](https://thursdai.news/releases/2026-07)

**Microsoft adds Sales and Service Agent to Outlook and Teams** — agents embedded where work already happens raise the bar for adoption and distribution. [Read more](https://www.aiapps.com/blog/july-ai-mega-update-major-breakthroughs-launches/)

**Dynamic Workflows in Claude Code** — dynamic workflows change how teams orchestrate coding agents and internal automations. [Read more](https://claude.com/blog/introducing-dynamic-workflows-in-claude-code)

**StepFun releases Step 3.7 Flash** — another fast, inexpensive model expands vendor options and cost pressure. [Read more](https://static.stepfun.com/blog/step-3.7-flash/)

**Screenpipe (YC S26)** — continuous user context is a powerful input, and a privacy risk, for agentic features. [Read more](https://news.ycombinator.com/item?id=49024620)

**Robinhood lets AI agents trade stocks** — a real case of giving agents real-world actions, with implications for trust and accountability. [Read more](https://techcrunch.com/2026/05/27/robinhood-now-lets-your-ai-agents-trade-stocks/)

**Noisy LLM evaluators still help** — do not wait for a perfect evaluation to start measuring agent quality. [Read more](https://www.tensorzero.com/blog/even-very-noisy-llm-evaluators-are-useful-for-improving-ai-agents/)

**OneCLI** — a credential gateway that keeps secrets outside agents; security is a blocker for enterprise adoption. [Read more](https://github.com/onecli/onecli)

**Promptloop** — creating, running, and improving prompt evaluations from the terminal reduces regressions in AI features. [Read more](https://github.com/Bella3202019/promptloop)
